...
const file_coin_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"coin.proto\x12\x02pb\"J\n" +
	"\x04Coin\x12\x12\n" +
	"\x04Coin\x18\x01 \x01(\x04R\x04Coin\x12\x16\n" +
	"\x06Symbol\x18\x02 \x01(\tR\x06Symbol\x12\x16\n" +
	"\x06Active\x18\x03 \x01(\bR\x06Active\"\x11\n" +
	"\x0fListCoinRequest\"0\n" +
	"\x10ListCoinResponse\x12\x1c\n" +
	"\x04coin\x18\x01 \x03(\v2\b.pb.CoinR\x04coinB\x06Z\x04./pbb\x06proto3"
